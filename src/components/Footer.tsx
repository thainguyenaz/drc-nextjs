...
const footerLinks = {
  ...
  Treatment: [
    ...
    { label: "CBT Therapy", href: "/treatments/understanding-cbt-cognitive-behavioral-therapy" },
    { label: "DBT Therapy", href: "/treatments/understanding-dbt-dialectic-behavior-therapy" },
    { label: "EMDR Therapy", href: "/treatments/emdr-eye-movement-desensitization-and-reprocessing" },
  ],
  Company: [
    ...
    { label: "Insurance", href: "/insurance-verification" },
