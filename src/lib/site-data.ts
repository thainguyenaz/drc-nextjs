export const siteData = {
      ...
      availableService: [
        {
          "@type": "MedicalTherapy",
          name: "Detoxification",
          description: "Medically supervised detoxification for adult men.",
        },
        {
          "@type": "MedicalTherapy",
      ...
      availableService: [
        {
          "@type": "MedicalTherapy",
          name: "Detoxification",
          description: "Medically supervised detoxification for adult women.",
        },
        {
          "@type": "MedicalTherapy",
          name: "Residential Treatment",
  ...
  team: {
    leadership: [
      { slug: "dr-an-nguyen", name: "Dr. An Nguyen", title: "Licensed Clinical Psychologist, Clinical Director", image: "/images/team/Dr-An-Nguyen.jpg", bio: "Dr. An Nguyen is a highly skilled clinical psychologist with extensive experience in mental health assessment, psychotherapy, and treating co-occurring disorders, a specialized area within the field of psychology that focuses on individuals who struggle with both substance use disorders and mental health issues. Her dedication to addressing the complex needs of these clients has made her a trusted expert in the field. She pursued a Doctorate in Clinical Psychology (Psy.D.), focusing on addiction and substance abuse treatment and co-occurring disorders. During her doctoral program, she received comprehensive training in evidence-based therapeutic approaches for clients with dual diagnoses." },
      { slug: "jason-inserra", name: "Jason Inserra", title: "Director of Operations", image: "/images/team/Jason-Inserra-3.jpg", bio: "Jason Inserra is a certified peer support specialist with a passion for recovery and helping others. With his education in substance abuse and lived experience, Jason is the director of our BHT team to provide individualized, quality care for all our clients. Jason has helped countless individuals through the 12-step program and assisted many others to find their own path of recovery. With his unique perspective, he strives to bring a fresh, relatable approach to recovery that is easy to understand and inspirational to all. Jason is active in the recovery community as a speaker, advocate, and podcast host, and brings his desire to educate and assist those in addiction to Desert Recovery Centers." },
      { slug: "adam-leonard", name: "Adam Leonard", title: "Admissions Director", image: "/images/team/Adam-Leonard.jpg", bio: "With a tenure spanning three years, Adam Leonard has demonstrated his expertise in Business Development and Admissions. He has successfully navigated the realm of two esteemed treatment facilities, both renowned for their excellence in serving a diverse clientele. Adam has forged impactful relationships with fellow treatment facilities, fostering collaborative partnerships crucial for business development. Drawing from his own recovery, Adam possesses a unique ability to connect with individuals grappling with substance use disorder, having celebrated an impressive seven years of recovery." },
      { name: "Blayne Archer", title: "Admissions & Business Development", image: "/images/team/Blayne-Archer.jpg", bio: "Blayne has spent his career serving in a variety of behavioral health roles, from case management to director of business development. For the past two years, he has worked on the admissions and business development team at Desert Recovery Centers, where he combines professional expertise with personal experience to help individuals begin recovery. Blayne brings genuine energy, compassion, and commitment to his work, believing that every person\u2019s path to healing is unique. With over ten years in long-term recovery himself, he uses his story to inspire others to embrace change, adopt a recovery mindset, and create a fulfilling life free from addiction." },
