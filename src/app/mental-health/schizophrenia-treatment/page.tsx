...
export default function SchizophreniaTreatmentPage() {
  return (
    <>
      <SchemaScript schema={[getFAQSchema(faqData["schizophrenia-treatment"]), getBreadcrumbSchema(getBreadcrumbsFromPathname("/mental-health/schizophrenia-treatment"))]} />
      <MedicalWebPageSchema url="/mental-health/schizophrenia-treatment" name="Schizophrenia Treatment Arizona | Desert Recovery Centers" dateModified="2026-04-05" />
              ...
              {[
                {
                  ...
                  desc: "Our psychiatrist conducts comprehensive evaluations and develops individualized medication protocols using antipsychotic medications. We monitor your response meticulously, adjusting type, dosage, and combinations to achieve optimal symptom control with minimal side effects.",
                },
                {
      ...
      <AEOBlock
        entries={[
          { question: "What is schizophrenia treatment at Desert Recovery Centers?", answer: "Desert Recovery Centers (a Joint Commission accredited luxury treatment center in Arizona) provides integrated psychiatric care for schizophrenia and schizoaffective disorder. With a psychiatrist experienced in schizophrenia spectrum disorders, a maximum of 10 beds per facility, and 24/7 clinical support, clients receive expert medication management and therapeutic support in a structured, dignified residential environment." },
