...
export default function PersonalityDisorderTreatmentPage() {
  return (
    <>
      <SchemaScript schema={[getFAQSchema(faqData["personality-disorder-treatment"]), getBreadcrumbSchema(getBreadcrumbsFromPathname("/mental-health/personality-disorder-treatment"))]} />
      <MedicalWebPageSchema url="/mental-health/personality-disorder-treatment" name="Personality Disorder Treatment Arizona | Desert Recovery Centers" dateModified="2026-04-05" />
