...
import { buildMetadata, SpeakableSchema, MedicalWebPageSchema, MedicalTherapySchema } from "@/lib/seo";
...
export default function TraumaTreatmentPage() {
  return (
    <>
      ...
      <MedicalWebPageSchema url="/mental-health/trauma-treatment" name="Trauma Treatment Center in Arizona" dateModified="2026-04-08" />
