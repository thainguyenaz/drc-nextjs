        ...
        <div className="max-w-container mx-auto px-6 text-center">
          ...
          >
            <p className="text-gray-600 text-sm mb-6">
              For commercial insurance, we work on an out-of-network basis with these carriers. Many out-of-network plans provide significant coverage for our level of care. We are also in-network with TRICARE through TriWest, and offer cash-pay options. Your benefits are verified before you start, at no cost to you.
            </p>
