...
export default function PhoenixPHPContent() {
  return (
    <>
      ...
      {/* Photo Gallery, full facility gallery */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
            ...
            <ScrollReveal delay={0.15}>
              <div className="rounded-xl overflow-hidden shadow-lg">
                <iframe
                  src="https://maps.google.com/maps?q=4160+N+108th+Ave+Phoenix+AZ+85037&output=embed"
                  width="100%"
                  height="350"
                  style={{ border: 0 }}
                  allowFullScreen
        ...
        <div className="max-w-container mx-auto px-6 text-center">
          ...
          >
            <p className="text-gray-600 text-sm mb-6">
              For commercial insurance, we work on an out-of-network basis with these carriers. Many out-of-network plans provide significant coverage for our level of care. We are in-network with TRICARE for residential treatment through TriWest; contact our admissions team to verify your TRICARE benefits for this location&apos;s programs. We also offer cash-pay options. Your benefits are verified before you start, at no cost to you.
            </p>
