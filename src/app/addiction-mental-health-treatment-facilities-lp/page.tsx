...
export const metadata: Metadata = {
  ...
  description:
    "Luxury addiction and mental health treatment in Arizona. Same-day admissions available. Out-of-network commercial insurance accepted. TRICARE accepted, in-network for residential treatment through TriWest. Joint Commission accredited. Call (623) 305-0496.",
            ...
            <div className="max-w-container mx-auto px-6 py-12 lg:py-16 grid lg:grid-cols-5 gap-10 lg:gap-14 items-start">
              <div className="lg:col-span-3">
                ...
                <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-8 max-w-2xl">
                  ...
                  TRICARE accepted, in-network for residential treatment through TriWest.{" "}
            ...
            <div className="max-w-container mx-auto px-6 py-10">
              ...
              <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
                ...
                <div
                  ...
                  role="img"
                  aria-label="TRICARE accepted, in-network for residential treatment through TriWest"
                >
                  ...
                  <span className="text-[10px] uppercase tracking-widest text-gray-500 mt-0.5">
                    In-Network for Residential Treatment Through TriWest
                  </span>
                </div>
              </div>
            </div>
          ...
          <section className="bg-white">
            <div className="max-w-container mx-auto px-6 py-16 md:py-20">
              ...
              <p className="text-center text-gray-400 text-xs mt-10 max-w-3xl mx-auto leading-relaxed">
                ...
                is in-network with TRICARE for residential treatment only, through TriWest; commercial insurance is
