...
const faqs = [
  ...
  },
  {
    ...
    a: "All DRC locations accept out-of-network coverage from the same major commercial insurance plans (Aetna, Blue Cross Blue Shield, Cigna, and UnitedHealthcare), are in-network with TRICARE through TriWest, and offer cash-pay options. Our admissions team verifies your benefits at no cost.",
  },
];
