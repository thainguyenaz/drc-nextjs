...
const faqSchema = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
  ...
  { "@type": "Question", name: "If my teenager is in crisis right now, what should I do?", acceptedAnswer: { "@type": "Answer", text: "Call 988, the Suicide and Crisis Lifeline, or take your teenager to the nearest emergency room. If they are in immediate danger, call 911. For non-emergency clinical consultation about next steps, contact our admissions team directly at (623) 323-1012." } },
] };
    ...
    <>
      ...
      <section className="py-20 md:py-28 bg-forest relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }} transition={{ duration: 0.6 }} className="max-w-container mx-auto px-6 text-center">
          ...
          <p className="text-gold text-sm font-medium mb-10">988 Suicide &amp; Crisis Lifeline available 24/7. Desert Recovery Centers admissions: (623) 323-1012.</p>
