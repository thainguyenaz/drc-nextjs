...
const speakableSchema = {
  ...
  url: "https://desertrecoverycenters.com/adolescent/bipolar",
};
        ...
        <div className="max-w-container mx-auto px-6"><div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center my-16">
              ...
              >
                <Image src="/images/adolescent/clinical/clinical-bipolar.jpg" alt="Group therapy for adolescent bipolar disorder at Desert Recovery Centers Arizona" fill className="object-cover w-full h-full object-center" />
              </motion.div>
              <div>
                <p className="text-gray-600 leading-relaxed text-sm">Our clinical team conducts thorough longitudinal assessments to accurately diagnose bipolar disorder and differentiate it from conditions with overlapping presentations.</p>
              </div>
            </div>
        </div></div>
      </section>
