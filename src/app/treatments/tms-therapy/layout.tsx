...
export const metadata: Metadata = {
  ...
  description:
    "Desert Recovery Centers Phoenix offers FDA-cleared NeuroStar TMS therapy for depression, anxious depression, OCD, and adolescents ages 15 and older. Drug-free. No downtime. Sessions as short as 19 minutes. Most insurance accepted. Call (623) 257-5384.",
