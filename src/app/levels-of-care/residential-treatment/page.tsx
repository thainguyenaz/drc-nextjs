        ...
        <div className="max-w-container mx-auto px-6">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-10 items-start">
            ...
            <p className="text-gray-600 leading-relaxed text-lg mb-6">
              ...
              out-of-network basis; we are in-network with TRICARE for residential treatment through
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Your care is led by licensed clinical psychologists, a psychiatrist, and experienced therapists, not technicians or entry-level counselors.",
                },
                {
