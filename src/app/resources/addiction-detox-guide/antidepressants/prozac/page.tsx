...
const faqs = [
  ...
  },
  {
    ...
    a: "Most major insurance plans cover medically supervised antidepressant discontinuation when it is part of a broader mental health or dual diagnosis treatment program. We are in-network with TRICARE through TriWest for residential treatment, and we accept most major commercial insurance plans on an out-of-network basis, with cash-pay options available. Our admissions team verifies your benefits at no cost before you begin.",
  },
];
