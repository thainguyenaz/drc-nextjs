        ...
        <div className="max-w-container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed text-lg mb-4">
              Dual diagnosis, also called co-occurring disorders, refers to the simultaneous presence of a mental health condition and a substance use disorder in the same individual. It is not a rare phenomenon. According to the Substance Abuse and Mental Health Services Administration (SAMHSA), approximately 21.2 million adults in the United States had a co-occurring mental illness and substance use disorder, per the 2024 National Survey on Drug Use and Health (<a href="https://www.samhsa.gov/substance-use/treatment/co-occurring-disorders" target="_blank" rel="noopener" className="text-sage underline hover:text-forest">SAMHSA: Co-Occurring Disorders</a>). Nearly half of all people who seek treatment for addiction also meet the diagnostic criteria for at least one mental health condition (<a href="https://nida.nih.gov/research-topics/co-occurring-disorders-health-conditions" target="_blank" rel="noopener" className="text-sage underline hover:text-forest">NIDA: Co-Occurring Disorders</a>).
            </p>
            <p className="text-gray-600 leading-relaxed text-lg mb-4">
