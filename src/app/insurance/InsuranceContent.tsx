            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-center gap-3">
                  ...
                  <span>Prefer to call? <a href="tel:+16233050496" className="text-sage font-medium">(623) 305-0496</a></span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-sage" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {[
                {
                  ...
                  desc: "We work with many insurance plans beyond those listed above. Call us at (623) 305-0496 and our admissions team will check your specific plan. We also offer private pay options and can discuss financing if needed.",
                },
                {
