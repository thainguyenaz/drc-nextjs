  ...
  return (
    <>
      ...
      <PageHero
        ...
        description="In-network with TRICARE for residential treatment through TriWest. Out-of-network coverage available from major commercial insurance plans, plus cash-pay options. Submit your details and we'll verify your benefits at no cost."
