...
const programs = [
  ...
  },
  {
    ...
    schedule: "FDA Cleared for Ages 15 and Older",
    body1:
...
function ProgramTabContent({ prog }: { prog: (typeof programs)[number] }) {
  return (
    <>
      ...
      <p className="text-gray-600 text-sm leading-relaxed mb-3">{prog.body1}</p>
      ...
      <div className="md:hidden space-y-3">
        {programs.map((prog) => (
          ...
          >
            <button
              onClick={() =>
                setOpenAccordion(openAccordion === prog.tag ? "" : prog.tag)
              }
