      ...
      <div className="max-w-container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Adolescent mental health conditions rarely announce themselves clearly. They hide behind behavior that looks like attitude, laziness, or defiance. These are the signs that something more serious may be happening.
          </p>
        </motion.div>
          ...
          {checked.size >= 3 && (
            ...
            >
              <p className="text-forest text-sm leading-relaxed mb-4">
                If you checked 3 or more of these, your teenager may benefit from a clinical evaluation. This does not mean something is permanently wrong. It means your child needs more support than they are currently getting, and that support is available. Call us at (623) 257-5384. Our team can help you understand what you are seeing.
              </p>
