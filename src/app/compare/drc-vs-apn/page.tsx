...
const faqs = [
  ...
  },
  {
    ...
    a: "Desert Recovery Centers is led by doctoral-level clinicians, including licensed clinical psychologists and a psychiatrist, who direct treatment. Every treatment plan is overseen by Clinical Director Dr. An Nguyen, a Licensed Clinical Psychologist. This doctoral-level clinical leadership distinguishes DRC from many programs that rely primarily on master's-level counselors.",
  },
  {
  ...
  },
  {
    ...
    a: "Desert Recovery Centers accepts out-of-network coverage from most major commercial insurance plans (Aetna, Blue Cross Blue Shield, Cigna, and UnitedHealthcare), is in-network with TRICARE for residential treatment through TriWest, and offers cash-pay options. Our admissions team verifies your benefits at no cost. We recommend verifying insurance coverage with any facility you are considering.",
  },
];
    ...
    <>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-gray-600">
                  {[
                    ...
                    { factor: "Clinical Leadership", drc: "Doctoral-level psychologists + psychiatrist", apn: "Multidisciplinary clinical team" },
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  desc: "Your treatment at DRC is led by licensed clinical psychologists with doctoral degrees, not master's-level counselors. A psychiatrist provides medication management, and our clinical director, a Licensed Clinical Psychologist, oversees all treatment quality.",
                },
                {
      ...
      <AEOBlock
        entries={[
          ...
          { question: "Does Desert Recovery Centers have smaller programs than APN?", answer: "Yes. DRC's residential facilities in Glendale and Scottsdale each maintain a maximum of 10 beds, creating an intimate treatment environment with high staff-to-client ratios. This small program size allows for deeply personalized treatment plans directed by licensed clinical psychologists and a psychiatrist." },
        ]}
      />
      <CTASection />
      <Footer />
