    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://challenges.cloudflare.com https://www.youtube.com https://s.ytimg.com https://cdn.livechatinc.com https://api.livechatinc.com https://*.tctm.co https://googleads.g.doubleclick.net https://www.googleadservices.com https://*.hs-scripts.com https://*.hubspot.com https://*.hsadspixel.net https://*.hs-analytics.net https://js.hscta.net https://js-eu1.hscta.net https://static.hsappstatic.net https://*.usemessages.com https://*.hs-banner.com https://*.hs-banner.net https://*.hubspotusercontent-na2.net https://*.hubspot.net https://*.hscollectedforms.net https://*.hsleadflows.net https://*.hsforms.net https://*.hsforms.com https://*.hubspotfeedback.com https://feedback.hubapi.com https://feedback-eu1.hubapi.com https://*.hsappstatic.net",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "img-src 'self' data: https: blob:",
              "font-src 'self' https://fonts.gstatic.com data:",
              "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://www.google.com https://www.googleadservices.com https://api.desertrecoverycenters.com https://challenges.cloudflare.com https://api.livechatinc.com https://cdn.livechatinc.com wss://*.livechatinc.com https://*.tctm.co https://*.hubspot.com https://*.hubapi.com https://js.hscta.net https://js-eu1.hscta.net https://*.hs-banner.com https://*.hsforms.com https://*.hscollectedforms.net https://*.hsadspixel.net https://*.hs-analytics.net https://stats.g.doubleclick.net https://ad.doubleclick.net https://*.hsappstatic.net",
